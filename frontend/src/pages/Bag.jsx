...
const Bag=()=>{
    ...
    useEffect(()=>{
        ...
        axios.get("https://fine-ruby-rattlesnake-suit.cyclic.app/cart",{
            headers:{"Authorization":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFtYXJAZ21haWwuY29tIiwiVXNlcklkIjoiNjNjZDUwYzdlZGNkMDM5ZjA2YmYwYTE0IiwiaWF0IjoxNjc0NDA3MTQ5fQ.qj6hJr1rBM7SkvAdWfaiwuNhqawJTP3SejcdvqN6qOo"}
        }).then(res=>res.data.length===0?cartEmp() : setCartItems(res.data)).catch((err)=>console.log(err));
    ...
    <div id="cartNavbar">
        ...
        <div style={{display:"flex",gap:"10px",alignItems:"center",margin:"auto",width:"35%"}}>
    ...
    <div style={{display:"flex",gap:"20px",width:"80%",margin:"auto"}}>
        ...
        <div style={{width:'360px'}}>
            ...
            {/* <button  onClick={()=>handlePlaceOrder()} style={{border:"1px solid black",width:"200px"}}>PLACEORDER</button>
            <button style={{border:"2px soldi black",backgroundColor:"#ff3e6c",height:"40px",paddingLeft:"20px",paddingRight:"20px",color:"white",marginTop:"20px"}} onClick={()=>handlePlaceOrder()}>PLACE ORDER</button> */}
            {/* <button onClick={handlePlaceOrder} style={{border:"1px solid black",width:"200px"}}>PLACE ORDER</button> */}
        </div>
    </div>
